...
const Hero = () => {
	return (
		<section
			id="hero"
			className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 sm:px-12 bg-gradient-to-b from-purple-50 via-gray-50 to-gray-50 dark:via-gray-900 dark:to-gray-900 transition-colors duration-500"
		>
			<img
				src={varunPic}
				alt="Varun Kandula"
			...
			<h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-800 mb-4">
				Hi, I'm <span className="text-purple-600">Varun Kandula</span>
			</h1>
			...
			<p className="max-w-xl text-gray-600 mb-6 leading-relaxed text-sm sm:text-base">
			...
			<div className="absolute bottom-0 w-full overflow-hidden leading-none">
				<svg
					...
					className="w-full h-[100px] text-gray-50 dark:text-gray-900"
				>
					<path
						fill="currentColor"
